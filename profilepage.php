...
// Placeholder for user data retrieval (to populate the form with existing values)
        ...
        <div class="col-md-3">
            ...
            <div class="card bg-dark text-light p-3">
                <div class="text-center">
                    <img src="<?php echo $user_data['profile_picture'] ?? 'default.jpg'; ?>" alt="Profile Picture" class="rounded-circle img-fluid" style="width: 100px; height: 100px;">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item"><a class="nav-link text-danger" href="delete_profile.php">Delete Profile</a></li>
            ...
            <div class="card bg-dark text-light p-4">
                ...
                <form action="update_profile.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mt-3">
                        ...
                        <textarea class="form-control" id="address" name="address" rows="2"><?php echo $user_data['street_address'] . ', ' . $user_data['city'] . ', ' . $user_data['state'] . ', ' . $user_data['postal_code'] . ', ' . $user_data['country']; ?></textarea>
                    </div>
