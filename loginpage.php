...
<?php if (isset($_GET['error'])): ?>
    ...
    <div id="main">
            ...
            <div id="from_part">
                ...
                <form method="POST" action="./PHP/login.php"> <!-- Ensure login.php handles login -->
            ...
            <div id="regis_from" style="display: none;">
                ...
                <form method="POST" action="./PHP/registration.php"><!-- Ensure registration.php handles registration -->
                    <label for="email">Enter email id</label>
